...
Usage — pipe newline-delimited JSON from the agent:
    ...
    python3 scripts/collect_websearch.py --output /tmp/js3_websearch_raw.json

Usage — append a single result:
    python3 scripts/collect_websearch.py \
      --append /tmp/js3_websearch_raw.json \
...
Usage — initialise an empty file:
    python3 scripts/collect_websearch.py --init /tmp/js3_websearch_raw.json
"""
